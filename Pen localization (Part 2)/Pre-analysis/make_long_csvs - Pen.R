...
setwd("C:/Users/Hp 14/Documents/expand_unity_exp_framework_data-main")
getwd()
dir()
...
measures_to_expand <- c("hand_pos", "cursor_pos", "pen_pos", "Indicator_position")
...
lengthen_all_data <- function(measures_to_expand) {
  ...
  ppt_paths <- list.dirs("data/rawpen", recursive = FALSE, full.names = TRUE)
